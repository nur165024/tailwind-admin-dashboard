...
const OurStaff = () => {
  ...
  const handleKeyPress = (event) => {
    if (event.key === "Enter") {
      ...
      const nameFilter = outStaffData.filter((staff) => {
        return (
          staff.phone.toLowerCase().indexOf(searchData.toLowerCase()) !== -1
        );
      });
      setOutStaffs(
        ...
        <form className="block">
          <div className="px-6 pt-8 h-full flex-grow w-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
            ...
            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              ...
              <div className="col-span-8 sm:col-span-4">
                <input
                  className="px-3 py-1 focus:outline-none dark:text-gray-300 leading-5 rounded-md focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:ring focus:ring-green-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700 border h-12 text-sm focus:outline-none block w-full bg-gray-100 dark:bg-white border-transparent focus:bg-white"
                  type="text"
                  name="title"
            ...
            <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
              ...
              <div className="col-span-8 sm:col-span-4">
                <select
                  className="px-2 py-1 dark:text-gray-300 rounded-md form-select focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:shadow-none focus:ring focus:ring-green-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700 leading-5 border h-12 text-sm focus:outline-none block w-full bg-gray-100 dark:bg-white border-transparent focus:bg-white"
                  name="role"
                >
                  <option value="" hidden="">
                    Staff role
